...
namespace Demandforce.DFLink.Controller
{
    ...
    public class TaskFactory
    {
        ...
        public static ITaskMaker CreateTask(string taskName)
        {
            ...
            var typeName = GetTypeNameFromConfiguration(taskName);
        ...
        public static string GetTypeNameFromConfiguration(string name)
        {
